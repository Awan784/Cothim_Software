...
<head>
    ...
    <title>{{ $purchaseReturn->return_no }} — Purchase Return</title>
    <style>
...
<body>
    <div class="toolbar">
        <span>Purchase Return {{ $purchaseReturn->return_no }}</span>
        <div>
            <a class="btn-back" href="{{ route('purchase-returns.index') }}">Back</a>
    ...
    <div class="page-wrap">
        <div class="sheet">
            <header class="header">
                ...
                <div class="doc-meta">
                    <p class="doc-label">Purchase return</p>
                    <p class="doc-no">{{ $purchaseReturn->return_no }}</p>
                    <p class="doc-date">Date: {{ ams_date($purchaseReturn->return_date) }}</p>
                </div>
            </header>

            <div class="parties">
                <div>
                    <div class="party-label">Returned by</div>
                ...
                <table class="items">
                    ...
                    <tfoot>
                        <tr class="grand">
                            ...
                            <td class="num">{{ ams_num($purchaseReturn->total_amount) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
            ...
            @if($purchaseReturn->notes)
                <p class="po-notes"><strong>Notes:</strong> {{ $purchaseReturn->notes }}</p>
            @endif
