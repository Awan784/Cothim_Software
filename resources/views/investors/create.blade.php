...
@section('content')
    <div class="pb-4">
        <div class="py-4 d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h4 mb-0">Create Investor</h1>
                <p class="mb-0">Add a new investor.</p>
            </div>
            <div>
        ...
        <div class="card p-4">
            <form method="post" action="{{ route('investors.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input name="opening_investment" value="{{ old('opening_investment', 0) }}" class="form-control @error('opening_investment') is-invalid @enderror">
