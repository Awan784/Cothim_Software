    ...
    <div class="pb-4">
        <div class="py-4 d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0">Update customer details.</p>
            </div>
            <div>
            ...
            <form method="post" action="{{ route('customers.update', $customer) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="email" type="email" value="{{ old('email', $customer->email) }}" class="form-control @error('email') is-invalid @enderror">
                        @error('email') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">VAT number</label>
                        <input name="vat_number" value="{{ old('vat_number', $customer->vat_number) }}" class="form-control @error('vat_number') is-invalid @enderror">
                ...
                <div class="mb-3">
                    ...
                    <input name="opening_balance" value="{{ old('opening_balance', $customer->opening_balance) }}" class="form-control @error('opening_balance') is-invalid @enderror">
