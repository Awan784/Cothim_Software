...
<head>
    ...
    <title>{{ $salesReturn->return_no }} — Sales Return</title>
    <style>
...
<body>
    <div class="toolbar">
        <span>Sales Return {{ $salesReturn->return_no }}</span>
        <div>
            <a class="btn-back" href="{{ route('sales-returns.index') }}">Back</a>
        ...
        <div class="sheet">
                ...
                <div>
                    ...
                    <p class="company-meta">
                        ...
                        @if($settings->get('company_vat_number'))
                            <br>NTN / VAT {{ $settings->get('company_vat_number') }}
                        @endif
                        @if($settings->get('company_cr_number'))
                            · CR {{ $settings->get('company_cr_number') }}
                        @endif
                        @if($settings->get('whatsapp'))
                            <br>Phone / WhatsApp {{ $settings->get('whatsapp') }}
                        @endif
                    </p>
                </div>
                <div class="doc-meta">
                    <p class="doc-label">Sales return</p>
                    <p class="doc-no">{{ $salesReturn->return_no }}</p>
                    <p class="doc-date">Date: {{ ams_date($salesReturn->return_date) }}</p>
                </div>
            </header>
            ...
            <div class="parties">
                ...
                <div>
                    ...
                    <div class="party-name">{{ $salesReturn->customer?->displayName() ?: '—' }}</div>
                    <div class="party-meta">
                        {{ collect([
                            $salesReturn->customer?->mobile ?: $salesReturn->customer?->phone,
                ...
                <table class="items">
                    ...
                    <tfoot>
                        <tr class="grand">
                            ...
                            <td class="num">{{ ams_num($salesReturn->total_amount) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
            ...
            @if($salesReturn->notes)
                <p class="po-notes"><strong>Notes:</strong> {{ $salesReturn->notes }}</p>
            @endif
