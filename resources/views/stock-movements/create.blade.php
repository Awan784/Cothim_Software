...
@section('content')
    <div class="pb-4">
        <div class="py-4 d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h4 mb-0">Create Stock Movement</h1>
                <p class="mb-0">Record stock in/out/adjust.</p>
            </div>
            <div>
            ...
            <form method="post" action="{{ route('stock-movements.store') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input name="quantity" value="{{ old('quantity') }}" class="form-control @error('quantity') is-invalid @enderror" required>
                        @error('quantity') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Unit Cost</label>
                        <input name="unit_cost" value="{{ old('unit_cost') }}" class="form-control @error('unit_cost') is-invalid @enderror">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <x-ams-datetime-input name="moved_at" :value="now()" required />
                    </div>
                    <div class="col-md-6 mb-3">
